...
<body>
	<div class="pageContent">
		<form id="objForm" action="${ctx}/officialmember/count/query" method="post">
			...
			<div class="well">
				...
				<button type="button" class="btn btn-primary" id="backId">活跃会员</button>
			</div>
		 </form>
	    	...
	    	<div class="panel">
			      <div class="panel-header">
					...
					<table class="table table-bordered definewidth">
						...
						<tr>
							<td class="tableleft">红利总额：</td>
							<td style="color:red;">${memberMoneyAmount} </td>
							<td class="tableleft">总红利总额：</td>
							<td style="color:red;">${allMemberMoneyAmount}</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="tableleft">活跃会员人数：</td>
							<td style="color:red;">${tradeCount} </td>
							<td class="tableleft">总活跃会员人数：</td>
							<td style="color:red;">${allTradeCount}</td>
						</tr>	
					</table>
	 ...
	 <script>
		$(function () {
			BUI.use('bui/overlay');
			bindSkipClick("backId", "${ctx}/officialmember/count/activemembers");
		});
	</script>
