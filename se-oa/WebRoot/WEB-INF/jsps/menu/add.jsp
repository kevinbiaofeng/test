	...
	<div class="pageContent">
		<div class="doc-content m10">
	    	<div class="panel">
				  ...
				  <form id="objForm">
				  	<input type="hidden" name="parentId" value="${not empty menu? menu.id: 0}"/>
					<table class="table table-bordered definewidth">
						<c:if test="${not empty menu}">
							<tr>
						        <td width="10%" class="tableleft">上级：</td>
						        <td style="color: blue;">${menu.name}</td>
						    </tr>
						</c:if>
					    <tr>
					    ...
					    <tr>
					        ...
					        <td><input type="text" name="code" id="code" value="${menu.code}-"/></td>
					    </tr>
					    <c:if test="${not empty menu}">
						    <tr>
					    ...
					    <c:choose>
					     ...
					     <tr>
                            ...
                            <td>
                               <input type="radio" name="showFlag" value="1" checked="checked"/> 显示
                               &nbsp;&nbsp;
                               <input type="radio" name="showFlag" value="2"/> 隐藏
                            </td>
                        </tr>
					    <tr>
      ...
      <script>
	    $(function () {
	    	...
	    	bindClick("save", "${ctx}/sysmenu/save");
	    });
	  </script>
