	...
	<div class="pageContent">
			  ...
			  <form id="objForm">
					...
					<table class="table table-bordered definewidth">
					    ...
					    <tr>
					        ...
					        <td><input type="text" name="code" value="${role.code }" id="code"/></td>
					    </tr>
					    <tr>
					        <td class="tableleft">说明：</td>
					        <td>
					        	<textarea name="remark" class="uneditable-textarea" cols="45" rows="5">${role.remark}</textarea>
					        </td>
					    </tr>
					    <tr>
      ...
      <script>
	    $(function () {
	    	...
	    	$("#objForm").validate({
	 			rules: {
	 				...
	 				code: {
	 					...
	 					remote:{
		 		               type:"GET",
		 		               url:"${ctx}/sysrole/validateCode?id=" + $("#id").val(),
		 		               data:{code:function(){
		 		            	   return $("#code").val();
		 		            	}
		 		            }
	    	...
	    	bindClick("modify", "${ctx}/sysrole/modify");
