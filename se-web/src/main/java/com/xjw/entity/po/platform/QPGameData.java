...
public class QPGameData extends BasePo {
	...
	public void setCommonCards(String commonCards) {
		this.commonCards = commonCards;
	}

	public BigDecimal getDijin() {
		return dijin;
	}

	public void setDijin(BigDecimal dijin) {
		this.dijin = dijin;
	}
