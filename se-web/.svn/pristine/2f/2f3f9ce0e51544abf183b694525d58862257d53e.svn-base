...
@Service
public class UserAccountIntegralChangeLogServiceImpl extends BaseServiceImpl<UserAccountIntegralChangeLog> implements UserAccountIntegralChangeLogService, BaseServcie<UserAccountIntegralChangeLog> {
  @Resource
