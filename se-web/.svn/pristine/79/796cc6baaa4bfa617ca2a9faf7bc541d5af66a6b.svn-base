...
@Service
public class FinalResourcesIndexServiceImpl extends BaseServiceImpl<FinalResourcesIndex> implements FinalResourcesIndexService, BaseServcie<FinalResourcesIndex> {
  @Resource
