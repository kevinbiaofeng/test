...
@Service
public class FinalResourcesValuesServiceImpl extends BaseServiceImpl<FinalResourcesValues> implements FinalResourcesValuesService, BaseServcie<FinalResourcesValues> {
  @Resource
